...
#1. use high-level Keras preprocessing utilities (such as tf.keras.utils.image_dataset_from_directory) and layers (such as tf.keras.layers.Rescaling)
...
for image_batch, labels_batch in train_ds:
  print(image_batch.shape)  #The image_batch is a tensor of the shape (32, 180, 180, 3).
  print(labels_batch.shape) #This is a batch of 32 images of shape 180x180x3 
  break                     #The label_batch is a tensor of the shape (32,)

#Standardize the data
#The RGB channel values are in the [0, 255] range. standardize values to be in the [0, 1] using tf.keras.layers.Rescaling
